...
assert.equal(vm.runInContext('totals().subtotal', context), 12550);
assert.equal(vm.runInContext('totals().tax', context), 1883);
assert.equal(vm.runInContext('totals().total', context), 14433);
...
assert.equal(vm.runInContext('totals().subtotal', context), 100100);
